...
<script>
  ...
  gtag('config', 'UA-121292257-2');
    ...
    <link rel="preload" href="https://getuikit.com/fonts/ProximaNova-Light-webfont.woff2" as="font" type="font/woff2"
        crossorigin>
  ...
  <!-- <div class="site-wrap"> -->
    ...
    <header class="site-navbar py-3 js-site-navbar site-navbar-target" role="banner" id="site-navbar">
      ...
      <div class="container">
		...
		<li><a href="http://auscashexplorer.org" class="nav-link" target="blank">Explorer</a></li>
		<li><a href="http://mint.australiacash.org:2016" class="nav-link" target="blank">Mint</a></li>
              </ul>
            </nav>
          </div>
    ...
    <div class="site-section" id="section-about">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade-up">
            <div class="text-left pb-1 border-primary mb-4">
              <h2 class="text-primary">About AustraliaCash</h2>
            </div>
            <p>Australiacash is a free open source peer-to-peer electronic system that is completely decentralized, without the need for a central server or trusted parties. Users hold the crypto keys to their own AustraliaCash and transact directly with each other, with the help of a peer-to-peer network to check for double-spending.</p>
            <p class="mb-5">Our goal is to share the technology of blockchain with the entire Australian community and supply an easy to use system that everyone can contribute and get involved in.</p>
        ...
        <center><a href="https://blockspot.io/coin/australia-cash/"><img src="images/blockspot.jpg" width="300"></a>&nbsp; &nbsp;
        <a href="https://coincodex.com/crypto/australia-cash/"><img src="images/coincodex.png" width="300"></a>&nbsp; &nbsp;
        <a href="https://coinpaprika.com/coin/aus-australia-cash/"><img src="images/coinpaprika.png" width="300"></a>
        </center>
      </div>
    </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4 d-flex">
              ...
              <div>
                ...
                <p><a href="https://play.google.com/store/apps/details?id=com.auswallet">Play Store</a></p>
              </div>
            </div>
          </div>
    ...
    <div class="site-section block-13" id="section-industries">
      ...
      <div class="owl-carousel nonloop-block-13">
        <div>
          <a href="https://github.com/AustraliaCash/AustraliaCash-Core/releases/download/v0.17.4.2/windows-binaries.zip" class="unit-1 text-center">
        ...
        <div>
          <a href="https://github.com/AustraliaCash/AustraliaCash-Core/releases/download/v0.17.4.1/AusCash-01741-osx64.zip" class="unit-1 text-center">
        ...
        <div>
          <a href="https://github.com/AustraliaCash/AustraliaCash-Core/releases/download/v0.17.4.2/linux-binaries.zip" class="unit-1 text-center">
        ...
        <div>
          <a href="https://play.google.com/store/apps/details?id=com.auswallet" class="unit-1 text-center">
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(images/hero_bg_2.jpg); background-attachment: fixed;" id="exchanges">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">

          <div class="col-md-7" data-aos="fade-up">
		<!--<a href="https://wallet.crypto-bridge.org/market/BRIDGE.AUS_BRIDGE.BTC" target="blank"><img src="images/cryptobridge.png" width="300">
		<br>
      ...
      <div class="container">
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <div class="scf-text">
                            <span class="counter">84,000,000 AUS</span><br>&nbsp;<br>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <div class="scf-text">
			<span class="counter"><?php include('supply.php') ?> AUS</span><br>&nbsp;<br>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <div class="scf-text">
			<span class="counter"><?php include('blocks.php') ?></span><br>&nbsp;<br>
	    ...
	    <div>
            <div class="testimonial">
              ...
              <blockquote>
                <div class="scf-text">
			<span class="counter"><?php include('hash.php') ?> MH/s</span><br>&nbsp;<br>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <div class="scf-text">
                            <span class="counter">765</span><br>&nbsp;<br>
                            <h6>Nodes</h6>
                        </div>
                <p class="author"></p>
              </blockquote>
...
<center><script type="text/javascript" src="https://unpkg.com/@coinpaprika/widget-currency/dist/widget.min.js"></script><div class="coinpaprika-currency-widget" data-primary-currency="btc" data-currency="aus-australia-cash" data-modules='["market_details","chart"]' data-update-active="false"></div></center>
      <div class="container">
      </div>
    </div>
        ...
        <!--<div class="row">
          ...
          <!--<div class="col-md-5">-->
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0"><a href="mailto:farsider350@protonmail.com">farsider350@protonmail.com</a></p>
      ...
      <div class="container">
        <div class="row">
		  ...
		  <li><a href="http://auscashexplorer.org" target="blank">Block Explorer</a></li>
  		  <li><a href="https://mint.australiacash.org" target="blank">Mining Pool</a></li>
                  <li><a href="https://autradex.systems/#buy" target="blank">How to Buy AUS</a></li>
                </ul>
              </div>
              <div class="col-md-3">
                <h2 class="footer-heading mb-4">Follow Us</h2>
                <a href="https://www.facebook.com/AusCash" class="pl-0 pr-3" title="Facebook"><span class="icon-facebook"></span></a>
                <a href="https://twitter.com/australia_cash" class="pl-3 pr-3" title="Twitter"><span class="icon-twitter"></span></a>
                <a href="https://github.com/AustraliaCash/AustraliaCash-Core" class="pl-3 pr-3" title="Github"><span class="icon-github"></span></a>
                <a href="https://discord.gg/W3uD9Ke" class="pl-3 pr-3" title="Discord"><span class="icon-headphones"></span></a>
              </div>
            </div>
          </div>
          <!--<div class="col-md-3">
